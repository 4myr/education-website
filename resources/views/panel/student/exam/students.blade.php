                    ...
                    <thead>
                        ...
                        @foreach($students as $key => $item)
                            <tr>
                                ...
                                <td>
                                    {{ $item['student']['answered'] ? 'بله' : 'خیر' }}
                                </td>
                                <td>
                                    {{ is_null($item['student']['answeredScore']) ? 'بدون نمره' : $item['student']['answeredScore']}}
                                </td>
                                <td class="text-end">
{{--                                    <a href="{{ route('panel.student.exam.students.check', ['exam' => $exam->id, 'student' => $item['student_id']]) }}" class="btn btn- btn-primary btn-sm">تصحیح</a>--}}
                                </td>
                            </tr>
                        @endforeach
                        </tbody>

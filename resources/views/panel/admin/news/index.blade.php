        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="جستجو اخبار">
                </div>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    <a href="{{ route('panel.admin.news.create') }}" class="btn btn-primary">افزودن خبر</a>
                </div>
            </div>
        </div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-40px">زمان انتشار
                            </th>
                        ...
                        @foreach($news as $key => $item)
                            <tr>
                                ...
                                <td>
                                    {{ $item->is_active ? 'منتشر شده' : 'پیش نویس' }}
                                </td>

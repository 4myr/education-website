        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="جستجو عنوان درسی">
                </div>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    <a href="{{ route('panel.admin.lecture-groups.create') }}" class="btn btn-primary">ایجاد عنوان درسی</a>
                </div>
            </div>
        </div>
        <div class="card-body pt-0">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    <thead>
                        ...
                        @foreach($lectureGroups as $key => $item)
                            <tr>
                                <td>
                                    {{ $item->id }}
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a href="{{ route('panel.admin.lecture-groups.edit', $item) }}" class="menu-link px-3">ویرایش</a>
                                        </div>
{{--                                        <div class="menu-item px-3">--}}
{{--                                            <a href="{{ route('panel.admin.lecture-groups.destroy', $item) }}" class="menu-link px-3">حذف</a>--}}
{{--                                        </div>--}}
                                    </div>
                                </td>
                            </tr>
